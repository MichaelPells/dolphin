...
def stop_server():
    process(service="stop_server").start()
...
class Thread:
    ...
    def __init__(self, group=None, target=None, name=None,
                 args=(), kwargs=None, *, daemon=None, service=None, handover=[]):
    ...
    def start(self):
        ...
        with _active_limbo_lock:
            _limbo[self] = self
        #try:
        _start_new_thread(self._bootstrap_inner, ())
        """except Exception:
            with _active_limbo_lock:
                del _limbo[self]
            raise"""
...
Mine = process(service="start", handover=["server"]).start()
